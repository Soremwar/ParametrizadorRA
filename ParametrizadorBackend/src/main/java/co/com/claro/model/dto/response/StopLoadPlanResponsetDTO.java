 ...
 * @author andresbedoya
 */
public class StopLoadPlanResponsetDTO implements Serializable{
   String odiLoadPlanInstanceId;
    ...
    public String toString() {
        return "StopLoadPlanResponsetDTO{" + "odiLoadPlanInstanceId=" + odiLoadPlanInstanceId + ", runCount=" + runCount + ", masterRepositoryId=" + masterRepositoryId + ", masterRepositoryTimestamp=" + masterRepositoryTimestamp + '}';
    }
